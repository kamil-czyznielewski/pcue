...
kDynamicThreadType = -1,
	...
	kCharGen_Server_ThreadType = 2,
	kCharGen_Worker_ThreadType = 3,
	kDiscard_Server_ThreadType = 4,
	kDiscard_Worker_ThreadType = 5,
	kEcho_Server_ThreadType = 6,
	kEcho_Worker_ThreadType = 7
};
#else	/* for asm access */
...
#define VDK_kMaxNumThreads 16
#define VDK_kMaxNumActiveSemaphores 40
