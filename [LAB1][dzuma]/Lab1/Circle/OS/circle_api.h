...
* @date     08/2009
* @version  4.0 OPEN4 support
* @date     05/2010
* @version  4.1 Fonts, transparency and application full screen support
* @date     08/2010
* @version  4.2  Add STM32L platform
* @date     04/2011
*
...
typedef u32( *tCircleFunc8 )( u32 param1, u32 param2, u32 param3, u32 param4, u32 param5, u32 param6, u32 param7, u32 param8 );
...
#define UTIL_IS_STAND_ALONE_ID          (UTIL2_ID + 1)   /* Get current mode, stand alone or not */
...
#define UTIL_SetIrqHandler(a,b)                 (((tCircleFunc2)(Circle_API [UTIL_SET_IRQ_HANDLER_ID])) ((s32)a,(u32) b))                    /* void UTIL_SetIrqHandler ( s32 , tHandler );*/
#define UTIL_GetIrqHandler(a)          (u32)    (((tCircleFunc1)(Circle_API [UTIL_GET_IRQ_HANDLER_ID])) ((s32)a))                            /* tHandler* UTIL_GetIrqHandler ( s32 );*/
#define UTIL_SetSchHandler(a,b)                 (((tCircleFunc2)(Circle_API [UTIL_SET_SCH_HANDLER_ID])) ((s32)a,(u32)b))                     /* void UTIL_SetSchHandler ( s32 , tHandler );*/
...
#define UTIL_IsStandAloneMode()        (u32)    (((tCircleFunc0)(Circle_API [UTIL_IS_STAND_ALONE_ID])) ())        
...
#define RGB_MAKE(xR,xG,xB)    ( ( (((xG)>>2)&0x07)<<13 ) + ( (xG)>>5 )  +      \
                                ( ((xB)>>3) << 8 )          +      \
...
#define LCD_SENDLCDCMD_ID                      (LCD_ID + 3)          /* Send one byte command to LCD.*/
#define LCD_SENDLCDDATA_ID                     (LCD_ID + 4)          /* Display one byte data to LCD.*/
#define LCD_READLCDDATA_ID                     (LCD_ID + 5)          /* Read LCD byte data displayed on LCD.*/
...
#define LCD_SETOFFSET_ID                       (LCD_ID + 20)         /* Activate the offset.*/
#define LCD_GETSCREENWIDTH_ID                  (LCD_ID + 21)         /* Return the width of the screen in pixels.*/
#define LCD_GETSCREENHEIGHT_ID                 (LCD_ID + 22)         /* Return the height of the screen in pixels.*/
#define LCD_SETFONTDEF_ID                      (LCD_ID + 23)         /* Change the current font definitition to fit with a new current font.*/
#define LCD_GETFONTDEF_ID                      (LCD_ID + 24)         /* Get the current font definitition.*/
#define LCD_CHANGEFONT_ID                      (LCD_ID + 25)         /* Change the current font and its definitition.*/
#define LCD_SETTRANSPARENCY_ID                 (LCD_ID + 26)         /* Return the transparency value for the characters.*/
#define LCD_GETTRANSPARENCY_ID                 (LCD_ID + 27)         /* Set the transparency value for the characters.*/
#define LCD_FULLSCREEN_ID                      (LCD_ID + 28)         /* Enable or disable the possibility to use all the screen.*/
...
#define LCD_DisplayChar(a,b,c,d,e,f)                 ((tCircleFunc6)(Circle_API [LCD_DISPLAYCHAR_ID])) ((u32)(a),(u32)(b),(u32)(c),(u32)(d),(u32)(e),(mag_t)(f))/*void  LCD_DisplayChar(u8 x, u8 y, u8 Ascii, u16 TextColor, u16 BGndColor, mag_t CharMagniCoeff);*/
...
#define LCD_SetOffset(a)                             ((tCircleFunc1)(Circle_API [LCD_SETOFFSET_ID])) ((u32)(a))                                                 /*void LCD_SetOffset( ENUM_Offset Offset );*/
#define LCD_GetScreenWidth()              (s16)      (((tCircleFunc0)(Circle_API [LCD_GETSCREENWIDTH_ID])) ())                                                  /*coord_t LCD_GetScreenWidth( void )*/
#define LCD_GetScreenHeight()             (s16)      (((tCircleFunc0)(Circle_API [LCD_GETSCREENHEIGHT_ID])) ())                                                 /*coord_t LCD_GetScreenHeight( void )*/
#define LCD_SetFontDef(a)                            ((tCircleFunc1)(Circle_API [LCD_SETFONTDEF_ID])) ((u32)(a))                                                /*void LCD_SetFontDef(u32* FontDef);*/
#define LCD_GetFontDef(a)                 (tFontDef*)((tCircleFunc0)(Circle_API [LCD_GETFONTDEF_ID])) ()                                                        /*tFontDef* LCD_GetFontDef( void );*/
#define LCD_ChangeFont(a)                            ((tCircleFunc1)(Circle_API [LCD_CHANGEFONT_ID])) ((u8)(a))                                                 /*void LCD_ChangeFont(u8 ENUM_FontID ID);*/
#define LCD_SetTransparency(a)                       ((tCircleFunc1)(Circle_API [LCD_SETTRANSPARENCY_ID])) ((bool)(a))                                          /*void LCD_SetTransparency( u8 NewTransparency )*/
#define LCD_GetTransparency()             (u8)       (((tCircleFunc0)(Circle_API [LCD_GETTRANSPARENCY_ID])) ())                                                 /*u8 LCD_GetTransparency( void )*/
#define LCD_FullScreen(a)                            ((tCircleFunc1)(Circle_API [LCD_FULLSCREEN_ID])) ((u8)(a))                                               /*void LCD_FullScreen( u8 FullScreenONOFF )*/
/// @endcond
...
#define DRAW_DISPLAYSTRING_ID                     (DRAW_ID + 7)         /* Display a x char max string of characters*/
#define DRAW_DISPLAYSTRINGINVERTED_ID             (DRAW_ID + 8)         /* Display a x char max string of characters with inverted colors*/
...
#define DRAW_DISPLAYSTRINGMODE_ID                 (DRAW_ID + 23)        /* Display a x char max string of characters with attributes*/
#define DRAW_DRAW_CIRCLE_ID                       (DRAW_ID + 24)        /* Display a circle with attributes*/
#define DRAW_DRAW_ELLIPSE_ID                      (DRAW_ID + 25)        /* Display a ellipse with attributes*/
#define DRAW_DRAW_POLYGONE_ID                     (DRAW_ID + 26)        /* Display a polygone*/
...
#define DRAW_DisplayStringWithMode(a,b,c,d,e,f)     ((tCircleFunc6)(Circle_API [DRAW_DISPLAYSTRINGMODE_ID])) ((u32)(a),(u32)(b),(u32)(c),(u32)(d),(u32)(e),(u32)(f))  /*void DRAW_DisplayStringWithMode( coord_t x, coord_t y, const u8* ptr, len_t len, bool mode, enumset_t align );*/
#define DRAW_Circle(a,b,c,d,e,f,g)                  ((tCircleFunc7)(Circle_API [DRAW_DRAW_CIRCLE_ID])) ((u32)(a),(u32)(b),(u32)(c),(u32)(d),(u32)(e),(u32)(f),(u32)(g))   /*DRAW_Circle(coord_t CENTER_x, coord_t CENTER_y, coord_t RADIUS_r, color_t Color, color_t Fill_Color, bool Fill, bool Circle);*/
#define DRAW_Ellipse(a,b,c,d,e,f,g,h)               ((tCircleFunc8)(Circle_API [DRAW_DRAW_ELLIPSE_ID])) ((u32)(a),(u32)(b),(u32)(c),(u32)(d),(u32)(e),(u32)(f),(u32)(g),(u32)(h))  /*DRAW_Ellipse( coord_t CENTER_x, coord_t CENTER_y, coord_t RADIUS_a, coord_t RADIUS_b, color_t Color, color_t Fill_Color, bool Fill, bool Ellipse);*/
#define DRAW_Polygon(a,b,c)                         ((tCircleFunc3)(Circle_API [DRAW_DRAW_POLYGONE_ID])) ((u32)(a),(u32)(b),(u32)(c))                         /*DRAW_Polygon(coord_t *points, u16 NUM_Points, color_t Line_Color)*/
...
#define MENU_GetTextColor()             (color_t)    (((tCircleFunc0)(Circle_API [MENU_GET_TEXTCOLOR_ID])) ())                /* color_t MENU_GetTextColor( void ) */
#define MENU_SetBGndColor(a)                         ((tCircleFunc1)(Circle_API [MENU_SET_BGNDCOLOR_ID])) ((u32)(a))          /* void MENU_SetBGndColor( s32 BGndColor ) */
#define MENU_GetBGndColor()             (color_t)    (((tCircleFunc0)(Circle_API [MENU_GET_BGNDCOLOR_ID])) ())                /* color_t MENU_GetBGndColor( void ) */
...
#define MENU_RestoreAppliDivider()                    ((tCircleFunc0)(Circle_API [MENU_RESTORE_APP_DIVIDER_ID])) ()           /* void MENU_RestoreAppliDivider( void ) */
...
#define BKP_SYS8     12    /*!<  Backup register reserved for OS  */
#define BKP_SYS9     13    /*!<  Backup register reserved for OS  */
#define BKP_SYS10    14    /*!<  Backup register reserved for OS  */
#define BKP_SYS11    15    /*!<  Backup register reserved for OS  */
#define BKP_SYS12    16    /*!<  Backup register reserved for OS  */
#define BKP_SYS13    17    /*!<  Backup register reserved for OS  */
#define BKP_SYS14    18    /*!<  Backup register reserved for OS  */
...
#define TOUCHSCR_GET_POSX_ID              (TOUCHSCR_ID + 7)      /* Get the horizontal position of the hit point according the LCD position*/
#define TOUCHSCR_GET_POSY_ID              (TOUCHSCR_ID + 8)      /* Get the vertical position of the hit point according the LCD position*/
...
#define TOUCHSCR_GetPosX()          (s32)                        (((tCircleFunc0)(Circle_API [TOUCHSCR_GET_POSX_ID])) () )           /* s32 TOUCHSCR_GetPos( void );*/
#define TOUCHSCR_GetPosY()          (s32)                        (((tCircleFunc0)(Circle_API [TOUCHSCR_GET_POSY_ID])) () )           /* s32 TOUCHSCR_GetPos( void );*/
...
/*                     AUDIO_Playback_frequence_enum frequence,*/                                                                                                                                /*                     AUDIO_format_enum format);*/
...
#define FS_CREATEDIR   (2+4)        // create dir (NTRF100521)
