...
* Return         : None.
*******************************************************************************/
NODEBUG void Mass_Storage_In( void )
{
    switch ( Bot_State )
    {
    case BOT_CSW_Send:
...
* Return         : None.
*******************************************************************************/
NODEBUG void Mass_Storage_Out( void )
{
    uint8_t CMD;
    CMD = CBW.CB[0];
...
* Return         : None.
*******************************************************************************/
NODEBUG void Transfer_Data_Request( uint8_t* Data_Pointer, uint16_t Data_Len )
{
...
* Return         : None.
*******************************************************************************/
NODEBUG void Set_CSW( uint8_t CSW_Status, uint8_t Send_Permission )
{
...
* Return         : None.
*******************************************************************************/
NODEBUG void Bot_Abort( uint8_t Direction )
{
    switch ( Direction )
    {
    case DIR_IN :
