...
* Return         : Status.
*******************************************************************************/
NODEBUG uint32_t USB_SIL_Init(void)
{
#ifndef STM32F10X_CL
...
* Return         : Status.
*******************************************************************************/
NODEBUG uint32_t USB_SIL_Write(uint8_t bEpAddr, uint8_t* pBufferPointer, uint32_t wBufferSize)
{
#ifndef STM32F10X_CL
...
*******************************************************************************/
NODEBUG uint32_t USB_SIL_Read(uint8_t bEpAddr, uint8_t* pBufferPointer)
{
