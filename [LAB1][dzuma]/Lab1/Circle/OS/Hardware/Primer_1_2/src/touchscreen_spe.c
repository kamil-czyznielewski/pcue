...
const tPOINT TS_RefSample[3] = { {115, 15}, {115, 115}, {15, 15}};
...
**/
/******************************************************************************/
NODEBUG void TOUCHSCR_Init( void )
{
    tPOINT samples[3];
...
*
*******************************************************************************/
NODEBUG enum MENU_code TOUCHSCREEN_Calibration( void )
{
    ...
    case 0 :
        if ( fTS_InitCal == 0 )
        {
            ...
            DRAW_DisplayString( 3, 55, "Press on",   17 );
            DRAW_DisplayString( 3, 40, "the black cross",   17 );
            DRAW_DisplayString( 3, 25, "with a stylus",   17 );
    ...
    case 6 :
        ...
        if ( !( TOUCHSCR_Info.TouchPress ) )
        {
            ...
            DRAW_DisplayString( 22, 55, "Calibration", 15 );
            DRAW_DisplayString( 44, 40, "done.", 15 );
