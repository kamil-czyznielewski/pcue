...
* @brief    Open4 STM32C specific general header for the CircleOS project.
* @author   YRT
* @date     09/2009
* @version  4.0
*
...
#define TOUCHSCREEN_AVAIL       1   // Touchscreeen is presetn but not managed
...
//#define FLASH_SIZE           (256-110)      // 110 Ko flash for constants
...
#define RCC_APBxPeriph_GPIOx_DB_LED RCC_APB2Periph_GPIOC
#define GPIOx_DB_LED                    GPIOC
#define GPIO_Pin_DB_LED1                GPIO_Pin_8
#define GPIO_Pin_DB_LED2                GPIO_Pin_9
...
#define USB_PWRON_PORT                    GPIOD  
#define USB_PWRON_PIN                     GPIO_Pin_14
#define RCC_APB2Periph_GPIO_PWRON         RCC_APB2Periph_GPIOD
#define USB_OVER_PORT                     GPIOD  
#define USB_OVER_PIN                      GPIO_Pin_15
#define RCC_APB2Periph_GPIO_OVER          RCC_APB2Periph_GPIOD
  
/*--------------------------------- SD CARD ------------------------------*/
#define SD_SPI                        SPI3
#define SD_SPI_CLOCK                  RCC_APB1Periph_SPI3
#define SD_SPI_PORT                   GPIOC
#define SD_SPI_GPIO_PORT_CLOCK        RCC_APB2Periph_GPIOC
#define SD_SPI_PIN_SCK                GPIO_Pin_10
#define SD_SPI_PIN_MISO               GPIO_Pin_11
#define SD_SPI_PIN_MOSI               GPIO_Pin_12
#define SD_SPI_GPIO_REMAP             GPIO_Remap_SPI3
#define SD_CS_GPIO_PORT               GPIOD
#define SD_CS_GPIO_PORT_CLOCK         RCC_APB2Periph_GPIOD
