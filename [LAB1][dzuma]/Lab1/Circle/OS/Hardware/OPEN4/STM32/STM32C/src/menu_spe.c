...
bool  MENU_BigFont = 0;             // Menu with char magni = 2 or not
...
enum MENU_code fAboutMgr( void )
{
    ...
    if ( MenuFirstDisplay )
    {
        ...
        freeMemoryFlash               = 256 - 158 - AppSizeCounter;
        DRAW_DisplayStringWithMode( 0, 200, "STM32C Primer", ALL_SCREEN, NORMAL_TEXT, CENTER );
        DRAW_DisplayStringWithMode( 0, 174, "CPU:STM32F107VCT6", ALL_SCREEN, NORMAL_TEXT, CENTER );
        ...
        DRAW_DisplayString( 146,    148,  "158",                  3 );
  ...
  void DB_LED_Init( void )
{
    ...
    RCC_PERIPH_GPIO_CLOCK_CMD( RCC_APBxPeriph_GPIOx_DB_LED, ENABLE );
