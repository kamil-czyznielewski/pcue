...
namespace VDK
{
	...
	VDK::IDTableElement g_ThreadIDElements[16+1];
	VDK::ThreadTable g_ThreadTable = {g_ThreadIDElements, 16+1};
    ...
    VDK::ThreadTemplate	g_ThreadTemplates[] = 
	{
		...
		INIT_THREADTEMPLATE_("kCharGen_Server_ThreadType",kPriority5, 512,  ::CharGen_Server_ThreadType_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false),
		INIT_THREADTEMPLATE_("kCharGen_Worker_ThreadType",kPriority7, 512,  ::CharGen_Worker_ThreadType_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false),
		INIT_THREADTEMPLATE_("kDiscard_Server_ThreadType",kPriority5, 512,  ::Discard_Server_ThreadType_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false),
		INIT_THREADTEMPLATE_("kDiscard_Worker_ThreadType",kPriority7, 512,  ::Discard_Worker_ThreadType_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false),
		INIT_THREADTEMPLATE_("kEcho_Server_ThreadType",kPriority5, 512,  ::Echo_Server_ThreadType_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false),
		INIT_THREADTEMPLATE_("kEcho_Worker_ThreadType",kPriority7, 512,  ::Echo_Worker_ThreadType_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false)
	};
...
HeapID g_IOObjectHeap = ksystem_heap;
    ...
    unsigned int kMaxNumThreads = 16;
	...
	extern const unsigned int kMaxNumActiveSemaphores=40;
	VDK::IDTableElement g_SemIDElements[40 + 1];
	SemaphoreTable g_SemaphoreTable = {g_SemIDElements, 40};
