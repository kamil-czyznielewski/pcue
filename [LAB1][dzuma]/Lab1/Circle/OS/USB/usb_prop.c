...
* Return         : None.
*******************************************************************************/
NODEBUG void Mass_Storage_SetConfiguration( void )
{
...
* Return         : None.
*******************************************************************************/
NODEBUG void Mass_Storage_ClearFeature( void )
{
...
* Return         : None.
*******************************************************************************/
NODEBUG void Mass_Storage_SetDeviceAddress( void )
{
...
* Return         : None.
*******************************************************************************/
NODEBUG void MASS_Status_In( void )
{
    return;
}
...
* Return         : None.
*******************************************************************************/
NODEBUG void MASS_Status_Out( void )
{
    return;
}
...
* Return         : RESULT.
*******************************************************************************/
NODEBUG RESULT MASS_Data_Setup( uint8_t RequestNo )
{
...
* Return         : RESULT.
*******************************************************************************/
NODEBUG RESULT MASS_NoData_Setup( uint8_t RequestNo )
{
    if (( Type_Recipient == ( CLASS_REQUEST | INTERFACE_RECIPIENT ) )
...
* Return         : RESULT.
*******************************************************************************/
NODEBUG RESULT MASS_Get_Interface_Setting( uint8_t Interface, uint8_t AlternateSetting )
{
...
* Return         : None.
*******************************************************************************/
NODEBUG uint8_t* MASS_GetDeviceDescriptor( uint16_t Length )
{
...
* Return         : None.
*******************************************************************************/
NODEBUG uint8_t* MASS_GetConfigDescriptor( uint16_t Length )
{
...
* Return         : None.
*******************************************************************************/
NODEBUG uint8_t* MASS_GetStringDescriptor( uint16_t Length )
{
...
* Return         : None.
*******************************************************************************/
NODEBUG uint8_t* Get_Max_Lun( uint16_t Length )
{
    if ( Length == 0 )
    {
